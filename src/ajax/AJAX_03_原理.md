...
3. 学习 XHR 也是了解 axios 内部与服务器交互过程的真正原理
   ...
   ![image-20230221182835545](AJAX_03_%E5%8E%9F%E7%90%86/image-20230221182835545.png)
...
4. 语法如下：
   ...
   ![image-20230221183057392](AJAX_03_%E5%8E%9F%E7%90%86/image-20230221183057392.png)
...
4. 需求：查询河北省下属的城市列表
   ...
   ![image-20230404133429378](AJAX_03_%E5%8E%9F%E7%90%86/image-20230404133429378.png)
...
1. 需求：和我们之前做的类似，就是不用 axios 而是用 XHR 实现，输入省份和城市名字后，点击查询，传递多对查询参数并获取地区列表的需求
   ...
   ![image-20230221184135458](AJAX_03_%E5%8E%9F%E7%90%86/image-20230221184135458.png)
...
2. 需求：通过 XHR 完成注册用户功能
   ...
   ![image-20230404135245271](AJAX_03_%E5%8E%9F%E7%90%86/image-20230404135245271.png)
...
2. Promise 的好处是什么？
   ...
   * 了解 axios 函数内部运作的机制
     ...
     ![image-20230222113651404](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222113651404.png)
...
3. Promise 的状态改变有什么用：调用对应函数，改变 Promise 对象状态后，内部触发对应回调函数传参并执行
   ...
   ![image-20230222120815484](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222120815484.png)
...
2. 需求：使用 Promise 和 XHR 请求省份列表数据并展示到页面上
   ...
   ![image-20230404140252181](AJAX_03_%E5%8E%9F%E7%90%86/image-20230404140252181.png)
...
1. 需求：基于 Promise 和 XHR 封装 myAxios 函数，获取省份列表展示到页面
   ...
   ![image-20230222130217597](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222130217597.png)
...
1. 需求：介绍本项目要完成的效果，和要实现的步骤和分的步骤和视频
   ...
   ![image-20230222133327806](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222133327806.png)
...
1. 介绍本视频要完成的效果：搜索匹配关键字相关城市名字，展示城市列表即可
   ...
   ![image-20230222133553010](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222133553010.png)
...
1. 介绍本视频要完成的效果：点击城市列表名字，切换当前页面天气数据
   ...
   ![image-20230222134653884](AJAX_03_%E5%8E%9F%E7%90%86/image-20230222134653884.png)
