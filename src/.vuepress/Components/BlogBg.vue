...
// 背景图片 明亮模式
@mixin bgStyle_light {
  background-color: rgba(255, 255, 255, 0.5); // 原色
  //background-image: linear-gradient(50deg, #fbc2eb 70%, #a6c1ee 30%);
  background-image: url("https://theme-hope-assets.vuejs.press/bg/10-light.svg");
}

// 背景图片 黑暗模式
@mixin bgStyle_dark {
  background-color: rgba(44, 62, 80, 0.4); // 原色
  background-image: url("https://theme-hope-assets.vuejs.press/bg/10-dark.svg");
}
