...
![image-20201020100112292](ES_use01/image-20201020100112292.png)

#### 1.2.2 衍生查询

在接口中直接指定查询方法名称便可查询，无需进行实现，如商品表中有商品名称、标题和关键字，直接定义以下查询，就可以对这三个字段进行全文搜索。

![image-20201020095859759](ES_use01/image-20201020095859759.png)
...
![image-20201020113456055](ES_use01/image-20201020113456055.png)

### 4.2 简单搜索

访问：http://localhost:8010/esProduct/search/simple?keyword=手机

![image-20201020135915200](ES_use01/image-20201020135915200.png)